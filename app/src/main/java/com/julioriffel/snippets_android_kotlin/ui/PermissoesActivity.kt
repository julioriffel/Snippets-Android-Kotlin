...
import com.julioriffel.snippets_android_kotlin.databinding.ActivityPermissoesBinding
import com.vmadalin.easypermissions.EasyPermissions
import com.vmadalin.easypermissions.annotations.AfterPermissionGranted
import com.vmadalin.easypermissions.dialogs.DEFAULT_SETTINGS_REQ_CODE
import com.vmadalin.easypermissions.dialogs.SettingsDialog

private const val TAG = "PermissoesActivity"
private const val REQUEST_CODE_CAMERA_PERMISSION = 123 // Numero aleatorio
...
class PermissoesActivity : AppCompatActivity(),
    ...
    private lateinit var binding: ActivityPermissoesBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPermissoesBinding.inflate(layoutInflater)
    ...
    private fun onClickRequestPermissionCameraButton() {
        if (hasCameraPermission()) {
            ...
            startActivity(Intent(this, LerCodigoBarrasActivity::class.java))
        } else {
